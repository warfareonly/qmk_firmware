...
| R  | S  | T   | H | D    | M   | N   | A   | I  | O   |
| /  | V  | G   | P | B    | X   | W   | .   | '  | DEL |
| NP | NP | ESC | E | BSPC | ENT | SPC | TAB | NP | NP  |
...
width = 19
mods_list = [x[0] for x in mods_list]
mods_dict = dict.fromkeys(tuple(mods_list))
symbol_names_dict = {}
...
<<table-layout-taphold(layer_name="BASE", tap_table=rsthd, hold_table=hold)>>,
...
<<table-layout-half(layer_name="NSSL", half_table=nssl, shift="true")>>
};
#+END_SRC
...
#+BEGIN_SRC C :MAIN NO :noweb yes :padline no :tangle ../../keyboards/crkbd/keymaps/manna-harbour_miryoku/config.h
// <<header>>
...
#+BEGIN_SRC C :MAIN NO :noweb yes :padline no :tangle ../../keyboards/crkbd/keymaps/manna-harbour_miryoku/keymap.c
// <<header>>
#+END_SRC
